#!/system/bin/sh
# MIUI White Android on Black Boot Animation Service Script
# This runs during boot to ensure proper animation loading

# Log boot animation load
echo "$(date): MIUI White Android on Black boot animation loaded" >> /data/local/tmp/bootfx.log
...
resetprop ro.bootanim.theme "miui_white_android_on_black"
