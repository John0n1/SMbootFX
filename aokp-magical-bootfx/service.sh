#!/system/bin/sh
# AOKP Magical Boot Animation Service Script
# This runs during boot to ensure proper animation loading

# Log boot animation load
echo "$(date): AOKP Magical boot animation loaded" >> /data/local/tmp/bootfx.log
...
resetprop ro.bootanim.theme "aokp_magical"
