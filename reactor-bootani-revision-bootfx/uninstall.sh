...
# Reactor BootAni (Revision) Boot Animation Uninstaller
ui_print "- Removing Reactor BootAni (Revision) boot animation..."
...
ui_print "- Reactor BootAni (Revision) boot animation removed successfully"
