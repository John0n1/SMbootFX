...
# Android KitKat Easter Egg Boot Animation Uninstaller
ui_print "- Removing Android KitKat Easter Egg boot animation..."
...
ui_print "- Android KitKat Easter Egg boot animation removed successfully"
