#!/system/bin/sh
# Cyanogen Android Boot Animation Service Script
# This runs during boot to ensure proper animation loading

# Log boot animation load
echo "$(date): Cyanogen Android boot animation loaded" >> /data/local/tmp/bootfx.log
...
resetprop ro.bootanim.theme "cyanogen_android"
