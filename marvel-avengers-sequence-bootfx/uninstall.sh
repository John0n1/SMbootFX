...
# Marvel Avengers Sequence Boot Animation Uninstaller
ui_print "- Removing Marvel Avengers Sequence boot animation..."
...
ui_print "- Marvel Avengers Sequence boot animation removed successfully"
