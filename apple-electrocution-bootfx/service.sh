#!/system/bin/sh
# Apple Electrocution Boot Animation Service Script
# This runs during boot to ensure proper animation loading

# Log boot animation load
echo "$(date): Apple Electrocution boot animation loaded" >> /data/local/tmp/bootfx.log
...
resetprop ro.bootanim.theme "apple_electrocution"
