...
# MIUI White Android on Blue Boot Animation Uninstaller
ui_print "- Removing MIUI White Android on Blue boot animation..."
...
ui_print "- MIUI White Android on Blue boot animation removed successfully"
