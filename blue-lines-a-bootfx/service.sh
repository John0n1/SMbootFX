#!/system/bin/sh
# Blue Lines A Boot Animation Service Script
# This runs during boot to ensure proper animation loading

# Log boot animation load
echo "$(date): Blue Lines A boot animation loaded" >> /data/local/tmp/bootfx.log
...
resetprop ro.bootanim.theme "blue_lines_a"
