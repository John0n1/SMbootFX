#!/system/bin/sh
# Cyanogen Dark Boot Logo Boot Animation Service Script
# This runs during boot to ensure proper animation loading

# Log boot animation load
echo "$(date): Cyanogen Dark Boot Logo boot animation loaded" >> /data/local/tmp/bootfx.log
...
resetprop ro.bootanim.theme "cyanogen_dark_boot_logo"
