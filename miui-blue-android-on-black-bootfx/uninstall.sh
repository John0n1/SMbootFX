...
# MIUI Blue Android on Black Boot Animation Uninstaller
ui_print "- Removing MIUI Blue Android on Black boot animation..."
...
ui_print "- MIUI Blue Android on Black boot animation removed successfully"
