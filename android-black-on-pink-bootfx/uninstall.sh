...
# Android Black on Pink Boot Animation Uninstaller
ui_print "- Removing Android Black on Pink boot animation..."
...
ui_print "- Android Black on Pink boot animation removed successfully"
