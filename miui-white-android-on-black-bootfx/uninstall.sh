...
# MIUI White Android on Black Boot Animation Uninstaller
ui_print "- Removing MIUI White Android on Black boot animation..."
...
ui_print "- MIUI White Android on Black boot animation removed successfully"
