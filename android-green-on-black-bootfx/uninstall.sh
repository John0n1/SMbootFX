...
# Android Green on Black Boot Animation Uninstaller
ui_print "- Removing Android Green on Black boot animation..."
...
ui_print "- Android Green on Black boot animation removed successfully"
