...
# Cyanogen Dark Boot Logo Boot Animation Uninstaller
ui_print "- Removing Cyanogen Dark Boot Logo boot animation..."
...
ui_print "- Cyanogen Dark Boot Logo boot animation removed successfully"
