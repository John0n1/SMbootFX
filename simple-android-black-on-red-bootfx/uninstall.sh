...
# Simple Android Black on Red Boot Animation Uninstaller
ui_print "- Removing Simple Android Black on Red boot animation..."
...
ui_print "- Simple Android Black on Red boot animation removed successfully"
